...
DEGRAUS = (
    ...
    ("acima_do_criterio", "Com algum procedimento acima do critério", "validade",
     "Solicita acima do critério de revisão em ao menos um procedimento. O "
...
def qualificar(sinal: pd.DataFrame, persistencia: pd.DataFrame | None,
               ...
               em_revisao: frozenset | set | None = None) -> pd.DataFrame:
    ...
    Parâmetros:
        ...
        em_revisao: IDs com classificação de área em revisão; None = ninguém
            (v2: nenhum — a fragilidade do rótulo fica na dim e não vira degrau).
